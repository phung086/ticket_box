...
- **UI Component**: `app/page.tsx` - Customize the ticket UI
...
Edit `app/page.tsx` to match your dApp's design.
...
The main UI component is `app/page.tsx`. Customize layout, copy, and styles there.
